  ...
  return (
    ...
    >
      ...
      <div
        ...
        {...props}
      >
        <div className="absolute top-0.5 left-19 flex items-center h-7">
          <div className="block w-0.5 h-2/3 bg-muted" />
          <SidebarTrigger />
        </div>
        <div
          data-sidebar="sidebar"
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "relative flex w-full border-t border-l flex-1 flex-col bg-background md:peer-data-[variant=inset]:m-2 md:mt-8 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-none md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2",
        className
      )}
      {...props}
    />
